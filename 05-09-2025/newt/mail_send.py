...
def send_gmail(to_address, subject, body):
    ...
    from_address = "mymail@gmail.com"
    app_password = "app password"  # generate in Google Account -> Security -> App passwords
...
result = send_gmail("recievers@gmail.com", "subject", "message"
